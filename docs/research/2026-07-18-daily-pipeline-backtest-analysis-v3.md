...
- **状态分布**: {'TRANSITION': 418, 'LIQUIDITY_SQUEEZE': 36, 'TIGHT_LIQUIDITY': 14}
...
- **风险预算均值**: 0.3541 → 0.4476
- **风险预算零日占比**: 7.7% → 1.3%

| 状态 | v1(插值) 天数 | v2(真实) 天数 | 变化 |
|------|--------------|--------------|------|
| LIQUIDITY_SQUEEZE | 36 | 36 | +0 |
| TIGHT_LIQUIDITY | 221 | 14 | -207 |
| TRANSITION | 211 | 418 | +207 |
...
| TIGHT_LIQUIDITY | 14 | 0.279 | [0.20, 0.30] |
| TRANSITION | 418 | 0.486 | [0.10, 0.50] |
...
|-----------|-----------|-----------|-----------|
| LIQUIDITY_SQUEEZE | 25 (69%) | 3 (8%) | 8 (22%) |
| TIGHT_LIQUIDITY | 3 (21%) | 7 (50%) | 4 (29%) |
| TRANSITION | 8 (2%) | 4 (1%) | 405 (97%) |
