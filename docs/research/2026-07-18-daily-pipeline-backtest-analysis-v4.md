...
- **状态分布**: {'TRANSITION': 171, 'RISK_ON': 252, 'LIQUIDITY_SQUEEZE': 36, 'TIGHT_LIQUIDITY': 9}
...
| RISK_ON | 0 | 252 | +252 |
| TIGHT_LIQUIDITY | 221 | 9 | -212 |
| TRANSITION | 211 | 171 | -40 |
...
| RISK_ON | 252 | 0.764 | [0.40, 0.80] |
| TIGHT_LIQUIDITY | 9 | 0.267 | [0.20, 0.30] |
| TRANSITION | 171 | 0.468 | [0.10, 0.50] |
...
|-----------|-----------|-----------|-----------|-----------|
| LIQUIDITY_SQUEEZE | 25 (69%) | 0 (0%) | 3 (8%) | 8 (22%) |
| RISK_ON | 2 (1%) | 228 (91%) | 0 (0%) | 21 (8%) |
| TIGHT_LIQUIDITY | 2 (22%) | 1 (11%) | 3 (33%) | 3 (33%) |
| TRANSITION | 7 (4%) | 23 (14%) | 3 (2%) | 138 (81%) |
